...
export const CHARACTERS = [
  { id: 'Steve', name: '史蒂夫', desc: '经典英雄', color: '#00AAAA', legs: '#0000AA', face: STEVE_FACE, projectileType: 'ARROW', autoTrack: true },
  { id: 'Alex', name: '亚历克斯', desc: '敏捷探险家', color: '#638257', legs: '#4C3322', face: ALEX_FACE, projectileType: 'ARROW', autoTrack: true },
  { id: 'Zombie', name: '僵尸', desc: '吃脑子...?', color: '#00AAAA', legs: '#0000AA', face: ZOMBIE_FACE, projectileType: 'POTION', autoTrack: true },
  { id: 'Skeleton', name: '骷髅', desc: '神射手', color: '#B0B0B0', legs: '#B0B0B0', face: SKELETON_FACE, projectileType: 'BONE', autoTrack: true },
  { id: 'Creeper', name: '苦力怕', desc: 'ssssss...', color: '#00AA00', legs: '#000000', face: CREEPER_FACE, projectileType: 'TNT', autoTrack: true },
  { id: 'Enderman', name: '末影人', desc: '瞬移者', color: '#111111', legs: '#111111', face: ENDERMAN_FACE, projectileType: 'PEARL', autoTrack: true },
  { id: 'Villager', name: '村民', desc: '哈!', color: '#624133', legs: '#624133', face: VILLAGER_FACE, projectileType: 'POTION', autoTrack: true },
  { id: 'Pigman', name: '猪人', desc: '中立亡灵', color: '#E0AA86', legs: '#4C3322', face: PIGMAN_FACE, projectileType: 'FIREBALL', autoTrack: true },
  { id: 'Herobrine', name: 'Herobrine', desc: '传说', color: '#00AAAA', legs: '#0000AA', face: HEROBRINE_FACE, projectileType: 'SKULL', autoTrack: true },
  { id: 'Blaze', name: '烈焰人', desc: '火焰领主', color: '#FFD700', legs: '#FFA500', face: BLAZE_FACE, projectileType: 'FIREBALL', autoTrack: true },
  { id: 'Dream', name: 'Dream', desc: '速通者', color: GREEN, legs: BLACK, face: DREAM_FACE, projectileType: 'PEARL', autoTrack: true },
  { id: 'Technoblade', name: 'Technoblade', desc: '血神', color: '#DB7093', legs: '#000000', face: TECHNO_FACE, projectileType: 'POTION', autoTrack: true },
  { id: 'Notch', name: 'Notch', desc: '创世神', color: '#000000', legs: '#000000', face: NOTCH_FACE, projectileType: 'EXPERIENCE', autoTrack: true },
  { id: 'Dinnerbone', name: 'Dinnerbone', desc: '倒立者', color: '#00AAAA', legs: '#0000AA', face: DINNERBONE_FACE, projectileType: 'ARROW', autoTrack: true },
  { id: 'Witch', name: '女巫', desc: '炼金术士', color: '#4B0082', legs: '#2E8B57', face: WITCH_FACE, projectileType: 'POTION', autoTrack: true },
  { id: 'Pillager', name: '掠夺者', desc: '灾厄村民', color: '#5F9EA0', legs: '#2F4F4F', face: PILLAGER_FACE, projectileType: 'ARROW', autoTrack: true },
  { id: 'Drowned', name: '溺尸', desc: '水鬼', color: '#476562', legs: '#2F4F4F', face: DROWNED_FACE, projectileType: 'TRIDENT', autoTrack: true },
  { id: 'WitherSkeleton', name: '凋零骷髅', desc: '地狱杀手', color: '#222222', legs: '#222222', face: WITHER_SKEL_FACE, projectileType: 'SKULL', autoTrack: true },
  { id: 'Slime', name: '史莱姆', desc: '弹跳者', color: '#73C056', legs: '#000000', face: SLIME_FACE, projectileType: 'SNOWBALL', autoTrack: true },
  { id: 'Spider', name: '蜘蛛', desc: '攀爬者', color: '#1E1E1E', legs: '#1E1E1E', face: SPIDER_FACE, projectileType: 'POTION', autoTrack: true },
  { id: 'IronGolem', name: '铁傀儡', desc: '守护者', color: '#DEDEDE', legs: '#9C9088', face: GOLEM_FACE, projectileType: 'SNOWBALL', autoTrack: true },
  { id: 'SnowGolem', name: '雪傀儡', desc: '雪人', color: '#FFFFFF', legs: '#FFFFFF', face: SNOW_GOLEM_FACE, projectileType: 'SNOWBALL', autoTrack: true },
  { id: 'Warden', name: '监守者', desc: '深渊守卫', color: '#0D1C24', legs: '#006666', face: WARDEN_FACE, projectileType: 'SONIC_BOOM', autoTrack: true },
  { id: 'Phantom', name: '幻翼', desc: '夜魇', color: '#3C4B82', legs: '#000000', face: PHANTOM_FACE, projectileType: 'EGG', autoTrack: true },
  { id: 'Allay', name: '悦灵', desc: '小帮手', color: '#64C9E7', legs: '#64C9E7', face: ALLAY_FACE, projectileType: 'EXPERIENCE', autoTrack: true },
  { id: 'Vex', name: '恼鬼', desc: '穿墙者', color: '#9CA6AB', legs: '#9CA6AB', face: VEX_FACE, projectileType: 'TRIDENT', autoTrack: true },
  { id: 'Bee', name: '蜜蜂', desc: '嗡嗡嗡', color: '#FFD700', legs: '#000000', face: BEE_FACE, projectileType: 'EGG', autoTrack: true },
  { id: 'Cow', name: '牛', desc: 'Moo', color: '#4D3319', legs: '#A6A6A6', face: COW_FACE, projectileType: 'SNOWBALL', autoTrack: true },
  { id: 'Pig', name: '猪', desc: 'Oink', color: '#F0B6B6', legs: '#F0B6B6', face: PIG_FACE, projectileType: 'EGG', autoTrack: true },
  { id: 'Sheep', name: '羊', desc: 'Baa', color: '#E5E5E5', legs: '#FFFFFF', face: SHEEP_FACE, projectileType: 'SNOWBALL', autoTrack: true }
];
...
export const MOBS: Record<string, MobConfig> = {
    ...
    'ENEMY_PHANTOM': { type: 'ENEMY_PHANTOM', width: 40, height: 24, hp: 5, vx: 2, color: '#1e3a8a', fly: true, behavior: 'FLY' },
    ...
    'ENEMY_RAVAGER': { type: 'ENEMY_RAVAGER', width: 48, height: 36, hp: 20, vx: 1.0, color: '#757575', behavior: 'WALK' },
    'ENEMY_VINDICATOR': { type: 'ENEMY_VINDICATOR', width: 24, height: 32, hp: 12, vx: 1.8, color: '#3B3B3B', behavior: 'WALK' },
